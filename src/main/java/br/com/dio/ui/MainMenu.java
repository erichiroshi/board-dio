...
public class MainMenu {
    ...
    public void execute() throws SQLException {
        ...
        while (true){
            ...
            System.out.println("======================");
            option = Integer.parseInt(lerConsole());
            switch (option){
                case 1 -> createBoard();
                case 2 -> selectBoard();
                case 3 -> deleteBoard();
	...
	private String lerConsole() {
		String leitura;
		do {
			leitura = IO.readln().trim();
		} while (leitura.isEmpty() || leitura.isBlank());
		return leitura;
	}
    ...
    private void createBoard() throws SQLException {
        ...
        var cancelColumnName = lerConsole();
    ...
    private void selectBoard() throws SQLException {
        ...
        var id = Long.parseLong(lerConsole());
        try(var connection = getConnection()){
